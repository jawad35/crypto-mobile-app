...
const Trade = ({ navigation, route, getCoinMarket, coins }) => {
  ...
  // console.log("SLEEECTED IN TRADE")
        ...
        >
          ...
          <View>
            <Text style={{ color: 'black' }}>
              High {selectedCoin?.high_24h}
            </Text>
            <Text style={{ color: 'black' }}>Low {selectedCoin?.low_24h}</Text>
            <Text style={{ color: 'black' }}>
              Vol {selectedCoin?.total_volume}
            </Text>
          </View>
        </View>
        <View>
          <View>
              ...
              {isLoading ? (
                ...
                selectedCoin?.sparkline_in_7d?.price && (
                  ...
                  >
                    ...
                    />
                    <CandlestickChart.Provider data={candleObjects}>
                      <CandlestickChart
                        height={280}
                        ...
                        {candleObjects && (
                          ...
                          >
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 1
                              ].close.toFixed(1)}
                            </Text>
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 4
                              ].close.toFixed(1)}
                            </Text>
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 7
                              ].close.toFixed(1)}
                            </Text>
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 10
                              ].close.toFixed(1)}
                            </Text>
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 13
                              ].close.toFixed(1)}
                            </Text>
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 17
                              ].close.toFixed(1)}
                            </Text>
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 20
                              ].close.toFixed(1)}
                            </Text>
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 24
                              ].close.toFixed(1)}
                            </Text>
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 28
                              ].close.toFixed(1)}
                            </Text>
                            <Text style={{ color: 'black', padding: 5 }}>
                              {candleObjects[
                                candleObjects.length - 32
                              ].close.toFixed(1)}
                            </Text>
                          </View>
                        )}
                      ...
                      >
                        ...
                        <CandlestickChart.PriceText
                          ...
                          style={{ color: 'black' }}
                        />
                        {/* <CandlestickChart.DatetimeText style={{color:"white"}} /> */}
                      </View>
                    ...
                    {candleObjects && (
                      ...
                      >
                        <Text style={{ color: 'black', padding: 5 }}>
                          {`${Math.abs(currentHour - 18)}${currentHour >= 0 ? '' : ''
                            }`}
                          :
                          {
                            Date(
                              candleObjects[candleObjects.length - 1].timestamp
                            )
                              .split(' ')[4]
                              .split(':')[1]
                          }
                        ...
                        <Text style={{ color: 'black', padding: 5 }}>
                          {`${Math.abs(currentHour - 12)}${currentHour >= 0 ? '' : ''
                            }`}
                          :
                          {
                            Date(
                        ...
                        <Text style={{ color: 'black', padding: 5 }}>
                          {' '}
                          {`${Math.abs(currentHour - 5)}${currentHour >= 0 ? '' : ''
                            }`}
                          :
                          {
                            Date(
                        ...
                        <Text style={{ color: 'black', padding: 5 }}>
                          {`${Math.abs(currentHour)}${currentHour >= 0 ? '' : ''
                            }`}
                          :
                          {
                            Date(
                  ...
                  // <LineChart
                  //   data={{
                  //     labels: timestamps.slice(1).reverse(), // Exclude the current time
                  //     datasets: [
                  //       {
                  ...
                  //     backgroundGradientFrom: "#312424ee",
                  //     backgroundGradientTo: "#11311c",
            ...
            <View style={styles.coins}>
              ...
              <Text
                style={[
                  styles.title,
                  { color: coin === 'MACD' ? 'aqua' : 'black' },
                ]}
                onPress={() => setCoin('MACD')}
              >
                MACD
              </Text>
              <Text
            ...
            >
              <TouchableOpacity onPress={() => setTab('current')}>
                <Text
                  style={[
                    styles.title,
                    { color: tab === 'current' ? 'black' : 'silver' },
                  ]}
                >
                  Current entrust
                </Text>
              ...
              <TouchableOpacity onPress={() => setTab('position')}>
                <Text
                  style={[
                    styles.title,
                    { color: tab === 'position' ? 'black' : 'silver' },
                  ]}
                >
                  Position
                </Text>
...
<View style={{
  ...
  <Checkbox
            ...
            <View>
            <Ionicons name="refresh-circle" size={35} color="black" alignSelf="center"/>
            </View>
          </View>
<View
  style={{
